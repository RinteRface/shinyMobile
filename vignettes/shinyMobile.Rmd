...
`f7Page()` accepts any of the following `{shinyMobile}` layouts: `f7SingleLayout`, `f7TabLayout`, or `f7SplitLayout` which we will discuss further in the Layouts section. 
...
`{shinyMobile}` offers three layouts: 
- `f7SingleLayout()`
- `f7TabLayout()`
- `f7SplitLayout()`.
