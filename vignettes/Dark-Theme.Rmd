...
vignette: >
  %\VignetteIndexEntry{Dark-Theme}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

By default, shinyF7 opens in light mode. However,
specifying the `f7Page()` dark_mode option to TRUE will enable this mode.

<a href="https://dgranjon.shinyapps.io/miniUI2TabsDark" target="_blank"><img src="figures/f7_tab_layout_dark_md.png" class="img-shadow" width= "514" height=" 400"></a>
...
<img src="figures/f7Dark_demo.png" class="img-shadow" width= "514" height=" 400">
