...
- shinyF7 has custom input for sidebar (`f7Panel()`) as well as a serve side update function:
...
The tapHold parameter ensure that the "long-press" feature is activated.
